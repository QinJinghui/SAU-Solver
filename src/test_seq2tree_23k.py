...
for fold in range(5):
    ...
    encoder.load_state_dict(torch.load(os.path.join(current_save_dir, "seq2tree_encoder_best_val_acc")))
    predict.load_state_dict(torch.load(os.path.join(current_save_dir, "seq2tree_predict_best_val_acc")))
    generate.load_state_dict(torch.load(os.path.join(current_save_dir, "seq2tree_generate_best_val_acc")))
    merge.load_state_dict(torch.load(os.path.join(current_save_dir, "seq2tree_merge_best_val_acc")))
    # print(encoder)
